...
class StandardNotesRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Lead-Notizen';

    protected static ?string $modelLabel = 'Lead-Notiz';

    protected static ?string $pluralModelLabel = 'Lead-Notizen';
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Lead-Notiz')
                    ->schema([
        ...
        return $table
            ...
            ->columns([
                Tables\Columns\IconColumn::make('is_favorite')
                    ...
                    ->action(function ($record) {
                        ...
                        $maxSortOrder = $record->customer->notes()
                ...
                Tables\Actions\CreateAction::make()
                    ...
                    ->mutateFormDataUsing(function (array $data): array {
                        ...
                        if ($data['is_favorite'] ?? false) {
                            $maxSortOrder = \App\Models\CustomerNote::where('customer_id', $this->getOwnerRecord()->id)
                                ->where('is_favorite', true)
                                ->max('sort_order') ?? 0;
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ->modalWidth('4xl')
                    ->form([
                        Forms\Components\Section::make('Lead-Notiz Details')
                            ->schema([
                                Forms\Components\TextInput::make('title')
                                    ->label('Titel')
                                    ->disabled(),
            ...
            ->emptyStateHeading('Keine Lead-Notizen vorhanden')
            ->emptyStateDescription('Erstellen Sie die erste Notiz für diesen Lead.')
