...
class ContractStandardNotesRelationManager extends RelationManager
{
    protected static string $relationship = 'contractNotes';

    protected static ?string $title = 'Vertragsnotizen - Standard';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\IconColumn::make('is_favorite')
                    ...
                    ->action(function ($record) {
                        ...
                        $maxSortOrder = SupplierContractNote::where('supplier_contract_id', $record->supplier_contract_id)
            ...
            ->emptyStateDescription('Erstellen Sie die erste Standard-Notiz für diesen Vertrag.')
