...
return new class extends Migration
{
    ...
    {
        Schema::create('solar_plant_article', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['solar_plant_id', 'article_id'], 'unique_solar_plant_article');
        });
    }
    ...
    {
        Schema::dropIfExists('solar_plant_article');
    }
};
