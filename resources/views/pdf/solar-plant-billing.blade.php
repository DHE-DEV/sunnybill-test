    ...
    <div class="header">
        ...
        <div class="company-info">
                    @if($logoBase64)
                        <img src="{{ $logoBase64 }}" 
                             alt="Firmenlogo" 
                             style="@if($companySetting->logo_styles){{ $companySetting->logo_styles }}; @else max-width: 150px; max-height: 60px; @endif object-fit: contain; position: relative; top: -15px; right: -15px;">
                    @endif
